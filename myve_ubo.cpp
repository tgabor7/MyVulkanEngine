...
namespace myve
{
	UBO::UBO(Device &device, Swapchain& swapchain) : device{device}, swapchain{swapchain}
	{
    ...
    void UBO::createDescriptorPool()
    {
        ...
        poolSize.descriptorCount = static_cast<uint32_t>(swapchain.getSwapChainImageCount());
